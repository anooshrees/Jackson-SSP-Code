...
pheatmap(rna.adj.data[rna.lmtop$adj.P.Val<0.001,names(rna.libsize)],show_rownames = F,scale = "row",color = colorRampPalette(c("#3360a4","#1a8af9","cornsilk","firebrick3","darkred"))(100),cutree_cols = 2,clustering_distance_rows = "correlation",clustering_distance_cols = "correlation",clustering_method = "complete")
# MA-plot:
